...
$chall = "gsvzhzshw";
$useradmin = "UUK14K";
$sim =-1003934458229; #القناة الرسمية
$PAY =-1003971312501; #الارقام المكتملة
$ess =-1004119320576; #عمليات شراء الارقام
$eer =-1003841829116; #اشعارات الايميلات وتحويل الروبل
if($chat_id==7666769955){
$sudo=$chat_id;
}elseif($chat_id==7666769955){
$sudo=$chat_id;
}else{
$sudo==7666769955;
}
